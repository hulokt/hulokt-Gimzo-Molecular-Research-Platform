...
const ModalLayout = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      // Call our Next.js API route instead of the NVIDIA API directly
      ...
      <div className="container mx-auto p-0 min-h-screen">
        ...
        <div className="grid grid-cols-1 gap-9 sm:grid-cols-3">
            <div className="flex flex-col gap-9 sm:col-span-2">
              ...
              {molecules.length > 0 && (
                <div className="rounded-lg border border-stroke bg-white p-6 shadow-default dark:border-[#121212] dark:bg-[#181818]">
              ...
              <div className="rounded-lg border border-stroke bg-white p-3 shadow-default dark:border-[#121212] dark:bg-[#181818]">
                ...
                <div className="mt-4 max-h-96 overflow-y-auto">
                  {history.map((entry: any, index) => (
                    <div key={entry._id || index} className="border-b border-stroke py-3">
