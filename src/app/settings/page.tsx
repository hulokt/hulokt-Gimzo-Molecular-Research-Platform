              ...
              <div className="p-7">
                <form onSubmit={handlePersonalInfoSubmit}>
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          className="w-full rounded-lg border border-stroke bg-gray py-3 pl-11.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none"
                          type="text"
                          name="firstName"
                  ...
                  <div className="flex justify-end gap-4.5">
                    <button
                      className="flex justify-center rounded-lg border border-stroke px-6 py-2 font-medium text-black hover:shadow-1"
                      type="button"
                    >
                      Cancel
                    </button>
            ...
            <div className="rounded-lg border border-stroke bg-white shadow-default">
              ...
              <div className="p-7">
                <form onSubmit={handleImageUploadSubmit}>
                  ...
                  <div
                    id="FileUpload"
                    className="relative mb-5.5 block w-full cursor-pointer appearance-none rounded-lg border border-dashed border-primary bg-gray px-4 py-4 sm:py-7.5"
                  >
                    <input
                      type="file"
                      accept="image/*"
